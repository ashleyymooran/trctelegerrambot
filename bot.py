...
def main():
    ...
    dispatcher.
add_handler(MessageHandler(Filters.text & ~Filters.command, search_phone_number))
    dispatcher.add_error_handler(error_handler)

    # تنظیمات webhook برای Render
    PORT = int(os.environ.get('PORT', 5000))
    
    # 🔥 IMPORTANT: اینجا نام اپلیکیشن Render خودت رو بذار 🔥
    APP_NAME = "YOUR_APP_NAME_HERE"  # این رو عوض کن!
